...
block
  ...
  type(SsTC_optical_BZ_integral_task) :: jdost

  call SsTC_default_jdos_constructor(optical_task = jdost, method = "extrapolation", &
                                     samples = (/100, 100, 100/), &
                                     omegastart = 0.0_dp, omegaend = 10.0_dp, &
                                     omegasteps = 100)

  call SsTC_sample_and_integrate_BZ_integral_task(task = jdost, &
                                                  system = GaAs)

  call SsTC_print_BZ_integral_task(task = jdost, &
                                   system = GaAs)
end block
.
.
