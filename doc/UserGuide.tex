...
\section{Installation \& linking to application}\label{sec:install}
...
\subsection{Example 2: Modularity and jerk current}
...
\begin{verbatim}
bash:/path/of/your/choice/SsTC/doc/examples/example2$ cp -r mymod ../../../src/calculators/
...
bash:/path/of/your/choice/SsTC/doc/examples/example2$ ls
compile.sh  example2.F90  GaAs-jc_*.dat  GaAs_tb.dat  mymod  SsTC_exec.err  SsTC_exec.out
test.x
\end{verbatim}
...
\caption{Jerk current tensor component $\iota^{xxxx}$ in the $\hbar\omega\in[0, 10]\;\text{eV}$ range.}
