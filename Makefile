...
main: $(SRC)/main.F90 utility.o extrapolation_integration.o integrator.o data_structures.o calculator_test.o calculators_floquet.o calculators_general.o kpath.o kslice.o
